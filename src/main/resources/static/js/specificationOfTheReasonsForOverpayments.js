    ...
    $("body").on('click', 'button', function () {
        ...
        if ($(this).hasClass("deleteSpecificationOfTheReasonsForOverpaymentsBtn")) {
            ...
            if(confirm("Удалить запись с ID = " +
                ...
                $.ajax({
                    url: "/aaaop/referenceBook/specificationOfTheReasonsForOverpayments/" + id,
                    cache: false,
                    processData: false,
                    type: 'DELETE',
        ...
        if ($(this).attr('id')==="updateOrAddSpecificationOfTheReasonsForOverpayments") {
            ...
            $.ajax({
                url: "/aaaop/referenceBook/specificationOfTheReasonsForOverpayments",
                data: data,
                cache: false,
                processData: false,
...
function ajaxSpecificationOfTheReasonsForOverpaymentsAll(params){
    $('#tableSpecificationOfTheReasonsForOverpayments tbody').html('<tr><th>' + getSpinner() + '</th><td></td><td></td><td></td></tr>');
    $.ajax({
        url: "/aaaop/referenceBook/specificationOfTheReasonsForOverpayments/All?" + params,
        data: "",
        cache: false,
        processData: false,
        contentType: "application/json",
